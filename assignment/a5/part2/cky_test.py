...
class TestParsing(unittest.TestCase):
    ...
    # TODO(jameskunz): Move these tests into pcfg_test.py.
    # Leaving here now to avoid pushing changes to ipynb after assignment release.
    def test_pcfg(self):
        o = pcfg.PCFG()
    ...
    def test_rule_application(self):
        ...
        cky.CKY_apply_binary_rules(len(sentence), grammar, chart)
